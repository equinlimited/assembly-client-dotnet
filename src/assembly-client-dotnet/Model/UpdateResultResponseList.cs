...
{
    /// <summary>
    /// A page of update_result_response objects
    /// </summary>
    [DataContract]
    public partial class UpdateResultResponseList :  IEquatable<UpdateResultResponseList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateResultResponseList" /> class.
        /// </summary>
        ...
        public UpdateResultResponseList(string _object = default(string), int? totalCount = default(int?), int? totalPages = default(int?), int? currentPage = default(int?), int? prevPage = default(int?), int? nextPage = default(int?), List<UpdateResultResponseListData> data = default(List<UpdateResultResponseListData>))
        {
            this.Object = _object;
        ...
        public List<UpdateResultResponseListData> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdateResultResponseList {\n");
        ...
        {
            return this.Equals(input as UpdateResultResponseList);
        }

        /// <summary>
        /// Returns true if UpdateResultResponseList instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateResultResponseList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateResultResponseList input)
        {
            if (input == null)
                return false;
