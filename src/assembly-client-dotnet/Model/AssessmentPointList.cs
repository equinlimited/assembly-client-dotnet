...
{
    /// <summary>
    /// A page of assessment_point objects
    /// </summary>
    [DataContract]
    public partial class AssessmentPointList :  IEquatable<AssessmentPointList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AssessmentPointList" /> class.
        /// </summary>
        ...
        public AssessmentPointList(string _object = default(string), int? totalCount = default(int?), int? totalPages = default(int?), int? currentPage = default(int?), int? prevPage = default(int?), int? nextPage = default(int?), List<AssessmentPointListData> data = default(List<AssessmentPointListData>))
        {
            this.Object = _object;
        ...
        public List<AssessmentPointListData> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AssessmentPointList {\n");
        ...
        {
            return this.Equals(input as AssessmentPointList);
        }

        /// <summary>
        /// Returns true if AssessmentPointList instances are equal
        /// </summary>
        /// <param name="input">Instance of AssessmentPointList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AssessmentPointList input)
        {
            if (input == null)
                return false;
