...
namespace assembly-client-dotnet.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class YearGroupList :  IEquatable<YearGroupList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="YearGroupList" /> class.
        /// </summary>
        ...
        public YearGroupList(string _object = default(string), int? totalCount = default(int?), int? totalPages = default(int?), int? currentPage = default(int?), int? prevPage = default(int?), int? nextPage = default(int?), List<YearGroupListData> data = default(List<YearGroupListData>))
        {
            this.Object = _object;
        ...
        public List<YearGroupListData> Data { get; set; }
        ...
        {
            return this.Equals(input as YearGroupList);
        }

        /// <summary>
        /// Returns true if YearGroupList instances are equal
        /// </summary>
        /// <param name="input">Instance of YearGroupList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(YearGroupList input)
        {
            if (input == null)
                return false;
