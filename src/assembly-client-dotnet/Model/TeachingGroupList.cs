...
{
    /// <summary>
    /// A page of teaching_group objects
    /// </summary>
    [DataContract]
    public partial class TeachingGroupList :  IEquatable<TeachingGroupList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TeachingGroupList" /> class.
        /// </summary>
        ...
        public TeachingGroupList(string _object = default(string), int? totalCount = default(int?), int? totalPages = default(int?), int? currentPage = default(int?), int? prevPage = default(int?), int? nextPage = default(int?), List<TeachingGroupListData> data = default(List<TeachingGroupListData>))
        {
            this.Object = _object;
        ...
        public List<TeachingGroupListData> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TeachingGroupList {\n");
        ...
        {
            return this.Equals(input as TeachingGroupList);
        }

        /// <summary>
        /// Returns true if TeachingGroupList instances are equal
        /// </summary>
        /// <param name="input">Instance of TeachingGroupList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TeachingGroupList input)
        {
            if (input == null)
                return false;
