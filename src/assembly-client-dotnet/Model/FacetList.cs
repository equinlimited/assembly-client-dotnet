...
{
    /// <summary>
    /// A page of facet objects
    /// </summary>
    [DataContract]
    public partial class FacetList :  IEquatable<FacetList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FacetList" /> class.
        /// </summary>
        ...
        public FacetList(string _object = default(string), int? totalCount = default(int?), int? totalPages = default(int?), int? currentPage = default(int?), int? prevPage = default(int?), int? nextPage = default(int?), List<FacetListData> data = default(List<FacetListData>))
        {
            this.Object = _object;
        ...
        public List<FacetListData> Data { get; set; }
        ...
        {
            return this.Equals(input as FacetList);
        }

        /// <summary>
        /// Returns true if FacetList instances are equal
        /// </summary>
        /// <param name="input">Instance of FacetList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FacetList input)
        {
            if (input == null)
                return false;
