...
{
    /// <summary>
    /// A page of update_multiple_result_response objects
    /// </summary>
    [DataContract]
    public partial class UpdateMultipleResultResponseList :  IEquatable<UpdateMultipleResultResponseList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateMultipleResultResponseList" /> class.
        /// </summary>
        ...
        public UpdateMultipleResultResponseList(string _object = default(string), int? totalCount = default(int?), int? totalPages = default(int?), int? currentPage = default(int?), int? prevPage = default(int?), int? nextPage = default(int?), List<UpdateMultipleResultResponseListData> data = default(List<UpdateMultipleResultResponseListData>))
        {
            this.Object = _object;
        ...
        public List<UpdateMultipleResultResponseListData> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpdateMultipleResultResponseList {\n");
        ...
        {
            return this.Equals(input as UpdateMultipleResultResponseList);
        }

        /// <summary>
        /// Returns true if UpdateMultipleResultResponseList instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateMultipleResultResponseList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateMultipleResultResponseList input)
        {
            if (input == null)
                return false;
