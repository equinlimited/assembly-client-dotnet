...
namespace assembly-client-dotnet.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SchoolDetailsList :  IEquatable<SchoolDetailsList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SchoolDetailsList" /> class.
        /// </summary>
        ...
        public SchoolDetailsList(string _object = default(string), int? totalCount = default(int?), int? totalPages = default(int?), int? currentPage = default(int?), int? prevPage = default(int?), int? nextPage = default(int?), List<SchoolDetailsListData> data = default(List<SchoolDetailsListData>))
        {
            this.Object = _object;
        ...
        public List<SchoolDetailsListData> Data { get; set; }
        ...
        {
            return this.Equals(input as SchoolDetailsList);
        }

        /// <summary>
        /// Returns true if SchoolDetailsList instances are equal
        /// </summary>
        /// <param name="input">Instance of SchoolDetailsList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SchoolDetailsList input)
        {
            if (input == null)
                return false;
