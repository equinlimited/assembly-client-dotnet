...
namespace assembly-client-dotnet.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class StaffContractList :  IEquatable<StaffContractList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StaffContractList" /> class.
        /// </summary>
        ...
        public StaffContractList(string _object = default(string), int? totalCount = default(int?), int? totalPages = default(int?), int? currentPage = default(int?), int? prevPage = default(int?), int? nextPage = default(int?), List<StaffContractListData> data = default(List<StaffContractListData>))
        {
            this.Object = _object;
        ...
        public List<StaffContractListData> Data { get; set; }
        ...
        {
            return this.Equals(input as StaffContractList);
        }

        /// <summary>
        /// Returns true if StaffContractList instances are equal
        /// </summary>
        /// <param name="input">Instance of StaffContractList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StaffContractList input)
        {
            if (input == null)
                return false;
