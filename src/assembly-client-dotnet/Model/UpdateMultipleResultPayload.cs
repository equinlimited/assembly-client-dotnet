...
namespace assembly-client-dotnet.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdateMultipleResultPayload :  IEquatable<UpdateMultipleResultPayload>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateMultipleResultPayload" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as UpdateMultipleResultPayload);
        }

        /// <summary>
        /// Returns true if UpdateMultipleResultPayload instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateMultipleResultPayload to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateMultipleResultPayload input)
        {
            if (input == null)
                return false;
