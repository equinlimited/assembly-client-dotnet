...
{
    /// <summary>
    /// A page of create_result_response objects
    /// </summary>
    [DataContract]
    public partial class CreateResultResponseList :  IEquatable<CreateResultResponseList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateResultResponseList" /> class.
        /// </summary>
        ...
        public CreateResultResponseList(string _object = default(string), int? totalCount = default(int?), int? totalPages = default(int?), int? currentPage = default(int?), int? prevPage = default(int?), int? nextPage = default(int?), List<CreateResultResponseListData> data = default(List<CreateResultResponseListData>))
        {
            this.Object = _object;
        ...
        public List<CreateResultResponseListData> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateResultResponseList {\n");
        ...
        {
            return this.Equals(input as CreateResultResponseList);
        }

        /// <summary>
        /// Returns true if CreateResultResponseList instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateResultResponseList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateResultResponseList input)
        {
            if (input == null)
                return false;
