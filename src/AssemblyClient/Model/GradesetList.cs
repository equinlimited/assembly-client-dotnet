...
{
    /// <summary>
    /// A page of gradeset objects
    /// </summary>
    [DataContract]
    public partial class GradesetList :  IEquatable<GradesetList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GradesetList" /> class.
        /// </summary>
        ...
        public GradesetList(string _object = default(string), int? totalCount = default(int?), int? totalPages = default(int?), int? currentPage = default(int?), int? prevPage = default(int?), int? nextPage = default(int?), List<GradesetListData> data = default(List<GradesetListData>))
        {
        ...
        public List<GradesetListData> data { get; set; }
        ...
        {
            return this.Equals(input as GradesetList);
        }

        /// <summary>
        /// Returns true if GradesetList instances are equal
        /// </summary>
        /// <param name="input">Instance of GradesetList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GradesetList input)
        {
            if (input == null)
                return false;
