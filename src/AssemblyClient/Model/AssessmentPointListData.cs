...
namespace AssemblyClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AssessmentPointListData :  IEquatable<AssessmentPointListData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AssessmentPointListData" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as AssessmentPointListData);
        }

        /// <summary>
        /// Returns true if AssessmentPointListData instances are equal
        /// </summary>
        /// <param name="input">Instance of AssessmentPointListData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AssessmentPointListData input)
        {
            if (input == null)
                return false;
