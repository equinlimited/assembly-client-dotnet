...
namespace AssemblyClient.Model
{
    ...
    public partial class SubjectList :  IEquatable<SubjectList>, IValidatableObject
    {
        ...
        public SubjectList(int? totalCount = default(int?), int? totalPages = default(int?), int? currentPage = default(int?), int? prevPage = default(int?), int? nextPage = default(int?), List<Subject> data = default(List<Subject>))
        {
