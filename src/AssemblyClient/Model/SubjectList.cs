...
namespace AssemblyClient.Model
{
    ...
    public partial class SubjectList :  IEquatable<SubjectList>, IValidatableObject
    {
        ...
        public SubjectList(string _object = default(string), int? totalCount = default(int?), int? totalPages = default(int?), int? currentPage = default(int?), int? prevPage = default(int?), int? nextPage = default(int?), List<SubjectListData> data = default(List<SubjectListData>))
        {
        ...
        public List<SubjectListData> data { get; set; }
