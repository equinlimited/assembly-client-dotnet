...
namespace AssemblyClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class Gradeset :  IEquatable<Gradeset>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="Gradeset" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as Gradeset);
        }

        /// <summary>
        /// Returns true if Gradeset instances are equal
        /// </summary>
        /// <param name="input">Instance of Gradeset to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Gradeset input)
        {
            if (input == null)
                return false;
