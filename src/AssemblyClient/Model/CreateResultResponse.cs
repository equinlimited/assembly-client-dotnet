...
namespace AssemblyClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CreateResultResponse :  IEquatable<CreateResultResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateResultResponse" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as CreateResultResponse);
        }

        /// <summary>
        /// Returns true if CreateResultResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateResultResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateResultResponse input)
        {
            if (input == null)
                return false;
