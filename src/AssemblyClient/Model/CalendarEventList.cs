...
namespace AssemblyClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CalendarEventList :  IEquatable<CalendarEventList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CalendarEventList" /> class.
        /// </summary>
        ...
        public CalendarEventList(string _object = default(string), int? totalCount = default(int?), int? totalPages = default(int?), int? currentPage = default(int?), int? prevPage = default(int?), int? nextPage = default(int?), List<CalendarEventListData> data = default(List<CalendarEventListData>))
        {
            this.Object = _object;
        ...
        public List<CalendarEventListData> Data { get; set; }
        ...
        {
            return this.Equals(input as CalendarEventList);
        }

        /// <summary>
        /// Returns true if CalendarEventList instances are equal
        /// </summary>
        /// <param name="input">Instance of CalendarEventList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CalendarEventList input)
        {
            if (input == null)
                return false;
