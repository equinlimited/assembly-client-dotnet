...
namespace AssemblyClient.Model
{
    ...
    public partial class YearGroup :  IEquatable<YearGroup>, IValidatableObject
    {
        ...
        public YearGroup(int? id = default(int?), string name = default(string), DateTime? startDate = default(DateTime?), DateTime? endDate = default(DateTime?), List<int?> supervisorIds = default(List<int?>), List<int?> studentIds = default(List<int?>), Subject subject = default(Subject))
        {
            this.Id = id;
            this.Name = name;
