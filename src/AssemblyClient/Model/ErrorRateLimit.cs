...
namespace AssemblyClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ErrorRateLimit :  IEquatable<ErrorRateLimit>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ErrorRateLimit);
        }

        /// <summary>
        /// Returns true if ErrorRateLimit instances are equal
        /// </summary>
        /// <param name="input">Instance of ErrorRateLimit to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ErrorRateLimit input)
        {
            if (input == null)
                return false;
