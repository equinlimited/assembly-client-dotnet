...
{
    /// <summary>
    /// A page of academic_year objects
    /// </summary>
    [DataContract]
    public partial class AcademicYearList :  IEquatable<AcademicYearList>, IValidatableObject
    {
        ...
        public AcademicYearList(string _object = default(string), int? totalCount = default(int?), int? totalPages = default(int?), int? currentPage = default(int?), int? prevPage = default(int?), int? nextPage = default(int?), List<AcademicYearListData> data = default(List<AcademicYearListData>))
        {
            this.Object = _object;
        ...
        public List<AcademicYearListData> Data { get; set; }
