...
{
    /// <summary>
    /// A page of staff_absence objects
    /// </summary>
    [DataContract]
    public partial class StaffAbsenceList :  IEquatable<StaffAbsenceList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StaffAbsenceList" /> class.
        /// </summary>
        ...
        public StaffAbsenceList(string _object = default(string), int? totalCount = default(int?), int? totalPages = default(int?), int? currentPage = default(int?), int? prevPage = default(int?), int? nextPage = default(int?), List<StaffAbsenceListData> data = default(List<StaffAbsenceListData>))
        {
            this.Object = _object;
        ...
        public List<StaffAbsenceListData> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StaffAbsenceList {\n");
        ...
        {
            return this.Equals(input as StaffAbsenceList);
        }

        /// <summary>
        /// Returns true if StaffAbsenceList instances are equal
        /// </summary>
        /// <param name="input">Instance of StaffAbsenceList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StaffAbsenceList input)
        {
            if (input == null)
                return false;
