...
{
    /// <summary>
    /// A page of staff_member objects
    /// </summary>
    [DataContract]
    public partial class StaffMemberList :  IEquatable<StaffMemberList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StaffMemberList" /> class.
        /// </summary>
        ...
        public StaffMemberList(string _object = default(string), int? totalCount = default(int?), int? totalPages = default(int?), int? currentPage = default(int?), int? prevPage = default(int?), int? nextPage = default(int?), List<StaffMemberListData> data = default(List<StaffMemberListData>))
        {
            this.Object = _object;
        ...
        public List<StaffMemberListData> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StaffMemberList {\n");
        ...
        {
            return this.Equals(input as StaffMemberList);
        }

        /// <summary>
        /// Returns true if StaffMemberList instances are equal
        /// </summary>
        /// <param name="input">Instance of StaffMemberList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StaffMemberList input)
        {
            if (input == null)
                return false;
