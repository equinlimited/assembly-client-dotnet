...
namespace AssemblyClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TeachingGroupListData :  IEquatable<TeachingGroupListData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TeachingGroupListData" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as TeachingGroupListData);
        }

        /// <summary>
        /// Returns true if TeachingGroupListData instances are equal
        /// </summary>
        /// <param name="input">Instance of TeachingGroupListData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TeachingGroupListData input)
        {
            if (input == null)
                return false;
