...
namespace AssemblyClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UpdateMultipleResultPayloadList :  IEquatable<UpdateMultipleResultPayloadList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateMultipleResultPayloadList" /> class.
        /// </summary>
        ...
        public UpdateMultipleResultPayloadList(string _object = default(string), int? totalCount = default(int?), int? totalPages = default(int?), int? currentPage = default(int?), int? prevPage = default(int?), int? nextPage = default(int?), List<UpdateMultipleResultPayloadListData> data = default(List<UpdateMultipleResultPayloadListData>))
        {
            this.Object = _object;
        ...
        public List<UpdateMultipleResultPayloadListData> Data { get; set; }
        ...
        {
            return this.Equals(input as UpdateMultipleResultPayloadList);
        }

        /// <summary>
        /// Returns true if UpdateMultipleResultPayloadList instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateMultipleResultPayloadList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateMultipleResultPayloadList input)
        {
            if (input == null)
                return false;
