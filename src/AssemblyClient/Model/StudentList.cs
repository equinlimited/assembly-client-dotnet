...
{
    /// <summary>
    /// A page of student objects
    /// </summary>
    [DataContract]
    public partial class StudentList :  IEquatable<StudentList>, IValidatableObject
    {
        /// <summary>
        ...
        public StudentList(string _object = default(string), int? totalCount = default(int?), int? totalPages = default(int?), int? currentPage = default(int?), int? prevPage = default(int?), int? nextPage = default(int?), List<StudentListData> data = default(List<StudentListData>))
        {
        ...
        {
            return this.Equals(input as StudentList);
        }

        /// <summary>
        /// Returns true if StudentList instances are equal
        /// </summary>
        /// <param name="input">Instance of StudentList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StudentList input)
        {
            if (input == null)
                return false;
