...
{
    /// <summary>
    /// A page of attendance objects
    /// </summary>
    [DataContract]
    public partial class AttendanceList :  IEquatable<AttendanceList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AttendanceList" /> class.
        /// </summary>
        ...
        public AttendanceList(string _object = default(string), int? totalCount = default(int?), int? totalPages = default(int?), int? currentPage = default(int?), int? prevPage = default(int?), int? nextPage = default(int?), List<AttendanceListData> data = default(List<AttendanceListData>))
        {
        ...
        public List<AttendanceListData> data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AttendanceList {\n");
        ...
        {
            return this.Equals(input as AttendanceList);
        }

        /// <summary>
        /// Returns true if AttendanceList instances are equal
        /// </summary>
        /// <param name="input">Instance of AttendanceList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AttendanceList input)
        {
            if (input == null)
                return false;
