...
namespace AssemblyClient.Model
{
    ...
    public partial class Assessment :  IEquatable<Assessment>, IValidatableObject
    {
        ...
        public Assessment(string _object = default(string), int? id = default(int?), string name = default(string), int? familyId = default(int?), string familyName = default(string), List<string> misMappings = default(List<string>))
        {
            this.Object = _object;
            this.Id = id;
            this.Name = name;
