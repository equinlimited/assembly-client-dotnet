...
namespace AssemblyClient.Model
{
    ...
    public partial class RegistrationGroupList :  IEquatable<RegistrationGroupList>, IValidatableObject
    {
        ...
        public RegistrationGroupList(int? totalCount = default(int?), int? totalPages = default(int?), int? currentPage = default(int?), int? prevPage = default(int?), int? nextPage = default(int?), List<RegistrationGroup> data = default(List<RegistrationGroup>))
        {
        ...
        public List<RegistrationGroup> Data { get; set; }
