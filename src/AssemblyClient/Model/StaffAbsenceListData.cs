...
namespace AssemblyClient.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class StaffAbsenceListData :  IEquatable<StaffAbsenceListData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StaffAbsenceListData" /> class.
        /// </summary>
        ...
        public StaffAbsenceListData(string _object = default(string), int? id = default(int?), int? staffMemberId = default(int?), DateTime? startDate = default(DateTime?), DateTime? endDate = default(DateTime?), float? workingDaysLost = default(float?), string absenceCategory = default(string), string illnessCategory = default(string), string payRate = default(string))
        {
            this.Object = _object;
            this.Id = id;
        ...
        {
            return this.Equals(input as StaffAbsenceListData);
        }

        /// <summary>
        /// Returns true if StaffAbsenceListData instances are equal
        /// </summary>
        /// <param name="input">Instance of StaffAbsenceListData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StaffAbsenceListData input)
        {
            if (input == null)
                return false;
