...
namespace AssemblyClient.Model
{
    ...
    public partial class ContactList :  IEquatable<ContactList>, IValidatableObject
    {
        ...
        public ContactList(string _object = default(string), int? totalCount = default(int?), int? totalPages = default(int?), int? currentPage = default(int?), int? prevPage = default(int?), int? nextPage = default(int?), List<ContactListData> data = default(List<ContactListData>))
        {
        ...
        public List<ContactListData> data { get; set; }
