...
namespace AssemblyClient.Model
{
    ...
    public partial class ResultList :  IEquatable<ResultList>, IValidatableObject
    {
        ...
        public ResultList(string _object = default(string), int? totalCount = default(int?), int? totalPages = default(int?), int? currentPage = default(int?), int? prevPage = default(int?), int? nextPage = default(int?), List<CreateResultPayloadResults> data = default(List<CreateResultPayloadResults>))
        {
