...
{
    /// <summary>
    /// A page of assessment objects
    /// </summary>
    [DataContract]
    public partial class AssessmentList :  IEquatable<AssessmentList>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AssessmentList" /> class.
        /// </summary>
        ...
        public AssessmentList(string _object = default(string), int? totalCount = default(int?), int? totalPages = default(int?), int? currentPage = default(int?), int? prevPage = default(int?), int? nextPage = default(int?), List<AssessmentListData> data = default(List<AssessmentListData>))
        {
            this.Object = _object;
        ...
        public List<AssessmentListData> Data { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AssessmentList {\n");
        ...
        {
            return this.Equals(input as AssessmentList);
        }

        /// <summary>
        /// Returns true if AssessmentList instances are equal
        /// </summary>
        /// <param name="input">Instance of AssessmentList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AssessmentList input)
        {
            if (input == null)
                return false;
